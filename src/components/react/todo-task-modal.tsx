...
import { X, Plus, Trash2, Calendar, Tag, AlertCircle, CheckSquare, Square } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className={`w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg ${
        ...
        <div className={`sticky top-0 p-6 border-b flex items-center justify-between ${
          settings.darkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'
        }`}>
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-sm border transition-colors ${
                      formData.labels.includes(label)
                        ...
                        : settings.labelColors[label] || 'bg-gray-100 text-gray-800 border-gray-200'
                    }`}
                  >
